...
const SINGLE_TAB: TabInfo[] = [{ title: 'Hello', url: 'https://example.com' }];

const EMPTY_TITLE_TAB: TabInfo[] = [{ title: '', url: 'https://example.com' }];
...
describe('formatTabs', () => {
    ...
    describe('html_table format', () => {
        ...
        it('escapes HTML in cell values', () => {
            const result = formatTabs('html_table', [
                { title: '<script>', url: 'https://x.com/?a=b&c=d' },
            ]);
